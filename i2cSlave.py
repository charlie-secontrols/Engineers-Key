...
class i2c_slave:
    ...
    def put(self, data):
        ...
        while not (mem32[self.i2c_base | self.IC_RAW_INTR_STAT] & 0x80):
            pass

        led.on()
        led.off()

        # Clear the transmit done flag
        mem32[self.i2c_base | self.IC_CLR_TX_DONE] = 1
